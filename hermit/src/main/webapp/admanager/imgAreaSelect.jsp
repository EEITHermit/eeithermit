...
<link rel="stylesheet"	href="<%=request.getContextPath()%>/css/imgareaselect-default.css" />
</head>
<body>
	<label for="fileImg" class="label-style">廣告圖片&nbsp;:&nbsp;</label>
	<input type="file" id="fileImg" name="fileImg" value="上傳圖片">
	<div><canvas id="layoutImg"></canvas></div>
	<div><canvas id="resultImg" style="display:none"></canvas></div>
	<img id="test"><button type="button" title="OK" id="buttonOK">確認</button>	
